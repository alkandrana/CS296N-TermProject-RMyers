...
public class SeedData
{
    public static void Seed(AppDbContext ctx, IServiceProvider provider)
    {
        if (!ctx.Entries.Any())
        {
            ...
            userManager.CreateAsync(contributor1, PASSWORD);
            ...
            userManager.CreateAsync(contributor2, PASSWORD);
            ...
            userManager.CreateAsync(contributor3, PASSWORD);
